...
| **3** | 조인행(allai14), 김남우(allai12) | **NVIDIA TurtleBot3 Dual Autonomous Navigation** | ✅ 주제 확정 |
| **4** | 유용준(allai03), 서예진(allai04) | **휴머노이드 기반 스마트팩토리 순찰·작업보조** | ✅ 주제 확정 |
| **5** | 김지윤(allai01), 권오주(allai08) | **스마트 물류창고 시뮬레이션** | ✅ 주제 확정 |
| **6** | 강영빈(allai02), 권영진(allai06) | — | 📝 주제 미정 |
| **7** | 원주성(allai07), 임희수(allai10) | — | 📝 주제 미정 |
...
| **설명** | 격자형 마을 맵에서 출발 지점부터 지정된 목적지들까지 이동하는 내비게이션 시뮬레이션.<br> 이동 중 동적 장애물과 신호등을 두어 회피하는 것이 목표 |
...
| 항목 | 내용 |
|------|------|
| **allai ID** | allai07(원주성), allai10(임희수) |
| **과제** | 🔲 미정 |
