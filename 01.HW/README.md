...
│                 │        │                 │        │                      │
│ Denver2 + A57   │        │ A57 quad-core   │        │ A78AE 6-core         │
│ HMP 6-core      │        │ 1.43 GHz        │        │ 1.7 GHz              │
│ 2.0 GHz         │        │                 │        │                      │
│                 │        │                 │        │                      │
│ 8GB LPDDR4      │        │ 4GB LPDDR4      │        │ 8GB LPDDR5           │
│ 59.7 GB/s       │        │ 25.6 GB/s       │        │ 102 GB/s             │
│                 │        │                 │        │                      │
│ 32GB eMMC       │        │ microSD         │        │ NVMe SSD (권장)      │
│                 │        │                 │        │                      │
│ 1.33 TFLOPS     │        │ 0.47 TFLOPS     │        │ 67 TOPS (INT8)       │
│ 7.5W / 15W      │        │ 5W / 10W        │        │ 7W / 15W / 25W       │
└─────────────────┘        └─────────────────┘        └──────────────────────┘
```

## 각 문서 바로가기

### [1-1_Jetson_TX2.md →](./1-1_Jetson_TX2.md)
- TX2 시리즈 4개 변종 (TX2 / TX2i / TX2 4GB / TX2 NX) 스펙 비교
- Pascal GPU 256 CUDA 코어 @ 1.30 GHz
- Denver2 + Cortex-A57 HMP 6코어 CPU
- 8GB LPDDR4 128bit, 32GB eMMC 5.1
- SDK Manager를 통한 초기 플래싱 방법
- Force Recovery Mode 진입 절차

### [1-2_Jetson_Nano_4GB_SD.md →](./1-2_Jetson_Nano_4GB_SD.md)
- Maxwell GPU 128 CUDA 코어 @ 921 MHz
- Cortex-A57 쿼드코어 CPU @ 1.43 GHz
- 4GB LPDDR4, 25.6 GB/s
- microSD 전용 — eMMC 없음
- A02 vs B01 캐리어 보드 리비전 차이
- Etcher로 SD 카드 이미지 기록
- Force Recovery Mode 진입 절차

### [1-3_Jetson_Orin_Nano_Super.md →](./1-3_Jetson_Orin_Nano_Super.md)
- **"Super" = 소프트웨어 업데이트만으로 1.7배 성능 향상**
- Ampere GPU 1024 CUDA 코어 + 32 Tensor 코어
- A78AE 6코어 CPU @ 1.7 GHz
- 8GB LPDDR5, 102 GB/s
- 67 TOPS (INT8) AI 성능
- NVMe SSD + microSD 스토리지
- MAXN SUPER 모드 (25W) 활성화 방법
- Orin Nano 4GB vs 8GB 모듈 비교
