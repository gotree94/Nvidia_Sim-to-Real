...
* smbus 패키지를 사용해서 앞에서는 mpu6050 의 회전 속도와 가속도를 확인했다면, 이번에는 온도까지 모니터링 해보세요.
...
GYRO_SCALE_MODIFIER_500DEG = 65.5 GYRO_SCALE_MODIFIER_1000DEG = 32.8 GYRO_SCALE_MODIFIER_2000DEG = 16.4
# Pre-defined ranges
ACCEL_RANGE_2G = 0x00
ACCEL_RANGE_4G = 0x08
ACCEL_RANGE_8G = 0x10
...
GYRO_ZOUT0 = 0x47
GYRO_ZOUT1 = 0x48
ACCEL_CONFIG = 0x1C GYRO_CONFIG = 0x1B
...
# Return the temperature return actual_temp
...
gyro_scale_modifier = self.GYRO_SCALE_MODIFIER_250DEG elif gyro_range == self.GYRO_RANGE_500DEG:
...
```
$ sudo python3 mpu6050_simpletest2.py
```
