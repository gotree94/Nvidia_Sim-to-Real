...
** Installl Ubuntu 를 눌러주세요. **

![Start VM](images/Image_022.jpg)
...
•    마우스 포인터 통합 (Mouse Pointer Intergration)
...
https://code.visualstudio.com/updates/v1_84
(참고: 최신 version 의 (24.05 월 기준 ver 1.89.1) Visual Sudio Code 가 ubuntu 18.04 에 설치되지 않아 구 version 의 Visual Studio Code 를 설치합니다.)
...
$ sudo ./nvmflash.shn    아래처럼 Flash complete (SUCCESS)라고 뜨면 jetson nano Clash 가 성공적으로 완료된 것입니다.  
...
n    다음 내용이 나오면 취소를 눌러주세요 
 n    Flash Completed! 문구가 나오면 Clash 가 완료된 것 입니다. SD 카드 리더기를 Host PC 와 분리해주세요. 
 
n    Jetson eMMC 에 Clash 가 완료되어 부팅이 되었으면 Jetson Nano Board SD Card Slot 에 SD Card 를 꽂아줍니다. 
